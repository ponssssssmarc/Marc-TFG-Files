...
\emph{Author:}\\
\reportauthor \\[10pt]% el teu nom
\emph{Institution:}\\
\institution % Nom de l'empresa o del grup de recerca acollidor del TFG
\end{flushleft}
\end{minipage}
~
\begin{minipage}{0.4\textwidth}
...
\emph{Supervisor:} \\
\supervisor \\[10pt] % Nom del Tutor\\
\emph{Academic Supervisor:}\\
\accsupervisor % Nom del tutor acadèmic
\end{flushright}
\end{minipage}\\[4cm]
