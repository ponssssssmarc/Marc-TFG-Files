...
# Opcio AMBER local( si es fa aixi canvia els path pels que toquin):
# export AMBERHOME=/home/10033023/software/pmemd24
# export PATH="$AMBERHOME/bin:$PATH"
# PMEMD="$AMBERHOME/bin/pmemd.cuda"
#
# Opcio AMBER via modul( si es fa aixi s'hauria de canviar el nom del modul) :
# module purge
# module load amber
# PMEMD="$(command -v pmemd.cuda)"
